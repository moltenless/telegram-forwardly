...
namespace TelegramForwardly.DataAccess.Migrations
{
    ...
    [Migration("20250722075749_ThresholdCharsCount")]
    partial class ThresholdCharsCount
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TelegramForwardly.DataAccess.Entities.Client", b =>
                {
                    ...
                    b.Property<int?>("ThresholdCharsCount")
                        .HasColumnType("int")
                        .HasColumnName("threshold_chars_count");
            ...
            modelBuilder.Entity("TelegramForwardly.DataAccess.Entities.ClientCurrentState", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 11L,
                            Value = "AwaitingDeleteConfirmation"
                        },
                        new
                        {
                            Id = 12L,
                            Value = "AwaitingRemoveChats"
                        },
                        new
                        {
                            Id = 13L,
                            Value = "AwaitingRemoveKeywords"
                        },
                        new
                        {
                            Id = 14L,
                            Value = "AwaitingThresholdCharsCount"
                        });
                });
